# [Robust-DefReg: a robust coarse to fine non-rigid point cloud registration method based on graph convolutional neural networks](https://iopscience.iop.org/article/10.1088/1361-6501/ad916c/meta)
